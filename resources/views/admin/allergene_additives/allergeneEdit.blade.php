        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-wrap p-2 rounded-3 shadow-lg bg-white">
                    ...
                    <form action="{{ route('admin.allergene.update', $allergene->id) }}" method="POST" class="row g-3">
                        @csrf
                        @method('PATCH')
                        <div class="col-md-6">
                            <label for="all_labelling" class="form-label @error('all_labelling') text-danger fw-bold @enderror">{{ __('Labelling') }}</label>
                            <input type="text" class="form-control @error('all_labelling') is-invalid @enderror" id="all_labelling" name="all_labelling" value="{{ $allergene->all_labelling }}">
                            @error('all_labelling')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('all_name') is-invalid @enderror" id="all_name" name="all_name" value="{{ $allergene->all_name }}">
                            @error('all_name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
