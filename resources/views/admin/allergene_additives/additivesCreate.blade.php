        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-wrap p-2 rounded-3 shadow-lg bg-white">
                    ...
                    <form action="{{ route('admin.additive.store') }}" method="POST" class="row g-3">
                        @csrf
                        <div class="col-md-6">
                            <label for="add_labelling" class="form-label @error('add_labelling') text-danger fw-bold @enderror">{{ __('Labelling') }}</label>
                            <input type="text" class="form-control @error('add_labelling') is-invalid @enderror" id="add_labelling" name="add_labelling">
                            @error('add_labelling')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('add_name') is-invalid @enderror" id="add_name" name="add_name">
                            @error('add_name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
